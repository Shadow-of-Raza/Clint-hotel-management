...
@Component({
  selector: 'app-hoteladmin-profile-update',
  templateUrl: './hoteladmin-profile-update.component.html',
  styleUrls: ['./hoteladmin-profile-update.component.css']
})
export class HoteladminProfileUpdateComponent  implements OnInit
{
  hoteladminid:number;
