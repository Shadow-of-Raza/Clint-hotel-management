...
export class DataService {
  ...
  sendEmailToAdmin(formData: any){
    return this.http.post(`http://localhost:8080/sendEmailToAdmin`,formData);
  }
  //1. Register Admin
...
//getAllActiveBookingInformationByHotelId
getAllActiveBookingInformationByHotelId(hotelid:number):Observable<BookingInformation[]>
{
  return this.http.get<BookingInformation[]>(`http://localhost:8080/getAllActiveBookingInformationByHotelId/${hotelid}`);
}

//reUpdateActiveStatusByBookingId
reUpdateActiveStatusByBookingId(bookingid:number)
{
  return this.http.put(`http://localhost:8080/reUpdateActiveStatusByBookingId/${bookingid}`,{});
}
...
setupRoom(roomSetupData:any):Observable<any>{
  return this.http.post<any>(`http://localhost:8080/setupRoom`,roomSetupData);
}

//getAllRoomInformationByCategoryId
getAllRoomInformationByHotelIdAndCategoryId(hotelid: number, roomcategoryid:number): Observable<any[]> {
  return this.http.get<any[]>(`http://localhost:8080/getAllRoomInformationByHotelIdAndCategoryId/${hotelid}/${roomcategoryid}`);
}
