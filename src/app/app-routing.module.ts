...
const routes: Routes = [
  ...
  {path: 'hoteladminactivebooking', component:HoteladminActiveBookingComponent},
  {path: 'hoteladminlogout',component:DashboardComponent},
  {path: 'hoteladminprofileupdate/:hoteladminid',component:HoteladminProfileUpdateComponent},
  ...
  {path: 'customerprofileupdate/:customerid', component:CustomerProfileUpdateComponent},
